    ...
    "Resources": [
      {
        type: "category",
        label: "Guides",
        items: ["guides/provide-liquidity-on-value-liquid-and-farm-for-value-rewards", "binance-smart-chain", 
         "guide-to-gvvalue-staking-on-binance-smart-chain", "vSafe-guide-on-binance-smart-chain", "vFarmsecurity" 
                "guides/save-on-transaction-fees-using-the-chi-gastoken", "Beltfi-guide"],
      },
      {
        type: "category",
        label: "FAQ",
